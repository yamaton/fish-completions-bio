...
complete -c trycycler -n "__fish_seen_subcommand_from cluster" -s "t" -l "threads" -d "Number of threads to use for alignment (default: 12)" -x
...
complete -c trycycler -n "__fish_seen_subcommand_from reconcile" -s "t" -l "threads" -d "Number of threads to use for alignment (default: 12)" -x
...
complete -c trycycler -n "__fish_seen_subcommand_from reconcile" -l "max_indel_size" -d "Maximum allowed pairwise indel size (default: 1000)" -x
...
complete -c trycycler -n "__fish_seen_subcommand_from msa" -s "t" -l "threads" -d "Number of threads to use for multiple sequence alignment (default: 12)" -x
...
complete -c trycycler -n "__fish_seen_subcommand_from consensus" -s "t" -l "threads" -d "Number of threads to use for alignment (default: 12)" -x
