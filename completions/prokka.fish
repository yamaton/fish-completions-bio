...
complete -c prokka -l "prefix" -d "Filename output prefix [auto] (default '')" -r
...
complete -c prokka -l "accver" -d "Version to put in Genbank file (default '1')" -r
...
complete -c prokka -l "prodigaltf" -d "Prodigal training file (default '')" -r
...
complete -c prokka -l "proteins" -d "FASTA or GBK file to use as 1st priority (default '')" -r
