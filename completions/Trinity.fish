...
complete -c Trinity -l long_reads -d ':fasta file containing error-corrected or circular consensus (CCS) pac bio reads' -r
...
complete -c Trinity -l output -d ':name of directory for output (will be' -r
