...
complete -c vcftools -l out -d 'This option defines the output filename prefix for all files generated by vcftools.' -r
...
complete -c vcftools -l TsTv -d 'Calculates the Transition / Transversion ratio in bins of size defined by this option.' -r
...
complete -c vcftools -l window-pi -l window-pi-step -d 'Measures the nucleotide diversity in windows, with the number provided as the window size.' -r
...
complete -c vcftools -l TajimaD -d 'Outputs Tajima\'s D statistic in bins with size of the specified number.' -r
...
complete -c vcftools -l SNPdensity -d 'Calculates the number and density of SNPs in bins of size defined by this option.' -r
...
complete -c vcftools -l extract-FORMAT-info -d 'Extract information from the genotype fields in the VCF file relating to a specfied FORMAT identifier.' -r
complete -c vcftools -l get-INFO -d 'This option is used to extract information from the INFO field in the VCF file.' -r
...
complete -c vcftools -l recode-INFO -l recode-INFO-all -d 'These options can be used with the above recode options to define an INFO key name to keep in the output file.' -r
complete -c vcftools -l contigs -d 'This option can be used in conjuction with the --recode-bcf when the input file does not have any contig declarations.' -r
