...
complete -c skesa -l fasta -d 'Input fasta file(s) (could be used multiple times for different runs) [string]' -r
complete -c skesa -l fastq -d 'Input fastq file(s) (could be used multiple times for different runs) [string]' -r
