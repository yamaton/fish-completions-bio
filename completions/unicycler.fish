...
complete -c unicycler -s 1 -l short1 -d 'FASTQ file of first short reads in each pair (required)' -r
complete -c unicycler -s 2 -l short2 -d 'FASTQ file of second short reads in each pair (required)' -r
complete -c unicycler -s s -l unpaired -d 'FASTQ file of unpaired short reads (optional)' -r
complete -c unicycler -s l -l long -d 'FASTQ or FASTA file of long reads (optional)' -r
complete -c unicycler -s o -l out -d 'Output directory (required)' -r
complete -c unicycler -l verbosity -d 'Level of stdout and log file information (default: 1)   0 = no stdout, 1 = basic progress indicators,   2 = extra info, 3 = debugging info' -r
