...
complete -c csvcut -s "d" -l "delimiter" -d "Delimiting character of the input CSV file." -r
complete -c csvcut -s "t" -l "tabs" -d "Specify that the input CSV file is delimited with tabs."
complete -c csvcut -s "q" -l "quotechar" -d "Character used to quote strings in the input CSV file." -r
complete -c csvcut -s "u" -l "quoting" -d "Quoting style used in the input CSV file." -r
...
complete -c csvcut -s "z" -l "maxfieldsize" -d "Maximum length of a single field in the input CSV file." -r
complete -c csvcut -s "e" -l "encoding" -d "Specify the encoding of the input CSV file." -r
