...
complete -c somalier -n "__fish_seen_subcommand_from extract" -s s -l sites -d 'sites vcf file of variants to extract' -x
complete -c somalier -n "__fish_seen_subcommand_from extract" -s f -l fasta -d 'path to reference fasta file' -x
...
complete -c somalier -n "__fish_seen_subcommand_from relate" -s g -l groups -d 'optional path to expected groups of samples (e.g. tumor normal pairs).' -x
...
complete -c somalier -n "__fish_seen_subcommand_from relate" -s p -l ped -d 'optional path to a ped/fam file indicating the expected relationships among samples.' -x
...
complete -c somalier -n "__fish_seen_subcommand_from ancestry" -l labels -d 'file with ancestry labels' -x
complete -c somalier -n "__fish_seen_subcommand_from ancestry" -s o -l output-prefix -d 'prefix for output files (default: somalier-ancestry)' -x
...
complete -c somalier -n "__fish_seen_subcommand_from find-sites" -s x -l exclude -d 'optional exclude files' -x
complete -c somalier -n "__fish_seen_subcommand_from find-sites" -s i -l include -d 'optional include file.' -x
