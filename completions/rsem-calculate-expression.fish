...
complete -c rsem-calculate-expression -l "temporary-folder" -d "Set where to put the temporary files generated by RSEM." -r
...
complete -c rsem-calculate-expression -l "chipseq-peak-file" -d "Full path to a ChIP-seq peak file in ENCODE's narrowPeak, i.e. BED6+4, format." -r
complete -c rsem-calculate-expression -l "chipseq-target-read-files" -d "Comma-separated full path of FASTQ read file(s) for ChIP-seq target." -r
complete -c rsem-calculate-expression -l "chipseq-control-read-files" -d "Comma-separated full path of FASTQ read file(s) for ChIP-seq conrol." -r
complete -c rsem-calculate-expression -l "chipseq-read-files-multi-targets" -d "Comma-separated full path of FASTQ read files for multiple ChIP-seq targets." -r
complete -c rsem-calculate-expression -l "chipseq-bed-files-multi-targets" -d "Comma-separated full path of BED files for multiple ChIP-seq targets." -r
