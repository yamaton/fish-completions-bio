...
complete -c csvstack -s u -l quoting -d 'Quoting style used in the input CSV file.' -x
...
complete -c csvstack -s z -l maxfieldsize -d 'Maximum length of a single field in the input CSV file.' -x
