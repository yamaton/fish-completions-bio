...
complete -c featureCounts -s "a" -d "Name of an annotation file." -r
complete -c featureCounts -s "o" -d "Name of output file including read counts." -r
complete -c featureCounts -s "F" -d "Specify format of the provided annotation file." -r
...
complete -c featureCounts -s "A" -d "Provide a chromosome name alias file to match chr names in annotation with those in the reads." -r
...
complete -c featureCounts -s "R" -d "Output detailed assignment results for each read or readpair." -r
complete -c featureCounts -l "Rpath" -d "Specify a directory to save the detailed assignment results." -r
complete -c featureCounts -l "tmpDir" -d "Directory under which intermediate files are saved (later removed)." -r
