...
complete -c promer -s "b" -l "breaklen" -d "Set the distance an alignment extension will attempt to extend poor scoring regions before giving up, measured in amino acids (default 60)"
complete -c promer -s "c" -l "mincluster" -d "Sets the minimum length of a cluster of matches, measured in amino acids (default 20)"
...
complete -c promer -s "d" -l "diagfactor" -d "Set the clustering diagonal difference separation factor (default .11)"
...
complete -c promer -s "g" -l "maxgap" -d "Set the maximum gap between two adjacent matches in a cluster, measured in amino acids (default 30)"
complete -c promer -s "h" -l "help" -d "Display help information and exit."
complete -c promer -s "l" -l "minmatch" -d "Set the minimum length of a single match, measured in amino acids (default 6)"
complete -c promer -s "m" -l "masklen" -d "Set the maximum bookend masking lenth, measured in amino acids (default 8)"
...
complete -c promer -s "p" -l "prefix" -d "Set the prefix of the output files (default \"out\")"
complete -c promer -s "V" -l "version" -d "Display the version information and exit"
complete -c promer -s "x" -l "matrix" -d "Set the alignment matrix number to 1 [BLOSUM 45], 2 [BLOSUM 62] or 3 [BLOSUM 80] (default 2)"
