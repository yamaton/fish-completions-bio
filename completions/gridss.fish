...
complete -c gridss -s "r" -l "reference" -d "reference genome to use."
complete -c gridss -s "o" -l "output" -d "output VCF."
complete -c gridss -s "a" -l "assembly" -d "location of the GRIDSS assembly BAM."
complete -c gridss -s "t" -l "threads" -d "number of threads to use."
complete -c gridss -s "j" -l "jar" -d "location of GRIDSS jar"
complete -c gridss -s "w" -l "workingdir" -d "directory to place GRIDSS intermediate and temporary files .gridss.working subdirectories will be created."
complete -c gridss -s "b" -l "blacklist" -d "BED file containing regions to ignore"
complete -c gridss -s "s" -l "steps" -d "processing steps to run."
complete -c gridss -s "c" -l "configuration" -d "configuration file use to override default GRIDSS settings."
complete -c gridss -s "l" -l "labels" -d "comma separated labels to use in the output VCF for the input files."
...
complete -c gridss -l "jobnodes" -d "total number of assembly jobs."
