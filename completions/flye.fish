...
complete -c flye -l pacbio-raw -d 'PacBio raw reads' -r
complete -c flye -l pacbio-corr -d 'PacBio corrected reads' -r
complete -c flye -l pacbio-hifi -d 'PacBio HiFi reads' -r
complete -c flye -l nano-raw -d 'ONT raw reads' -r
complete -c flye -l nano-corr -d 'ONT corrected reads' -r
complete -c flye -l subassemblies -d 'high-quality contigs input' -r
