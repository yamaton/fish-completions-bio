complete -c bcftools -n __fish_use_subcommand -a index -d 'index VCF/BCF files'
complete -c bcftools -n __fish_use_subcommand -a annotate -d 'annotate and edit VCF/BCF files'
complete -c bcftools -n __fish_use_subcommand -a concat -d 'concatenate VCF/BCF files from the same set of samples'
complete -c bcftools -n __fish_use_subcommand -a convert -d 'convert VCF/BCF files to different formats and back'
complete -c bcftools -n __fish_use_subcommand -a isec -d 'intersections of VCF/BCF files'
complete -c bcftools -n __fish_use_subcommand -a merge -d 'merge VCF/BCF files files from non-overlapping sample sets'
complete -c bcftools -n __fish_use_subcommand -a norm -d 'left-align and normalize indels'
complete -c bcftools -n __fish_use_subcommand -a plugin -d 'user-defined plugins'
complete -c bcftools -n __fish_use_subcommand -a query -d 'transform VCF/BCF into user-defined formats'
complete -c bcftools -n __fish_use_subcommand -a reheader -d 'modify VCF/BCF header, change sample names'
complete -c bcftools -n __fish_use_subcommand -a sort -d 'sort VCF/BCF file'
complete -c bcftools -n __fish_use_subcommand -a view -d 'VCF/BCF conversion, view, subset and filter VCF/BCF files'
complete -c bcftools -n __fish_use_subcommand -a call -d 'SNP/indel calling'
complete -c bcftools -n __fish_use_subcommand -a consensus -d 'create consensus sequence by applying VCF variants'
complete -c bcftools -n __fish_use_subcommand -a cnv -d 'HMM CNV calling'
complete -c bcftools -n __fish_use_subcommand -a csq -d 'call variation consequences'
complete -c bcftools -n __fish_use_subcommand -a filter -d 'filter VCF/BCF files using fixed thresholds'
complete -c bcftools -n __fish_use_subcommand -a gtcheck -d 'check sample concordance, detect sample swaps and contamination'
complete -c bcftools -n __fish_use_subcommand -a mpileup -d 'multi-way pileup producing genotype likelihoods'
complete -c bcftools -n __fish_use_subcommand -a polysomy -d 'detect number of chromosomal copies'
complete -c bcftools -n __fish_use_subcommand -a roh -d 'identify runs of autozygosity (HMM)'
complete -c bcftools -n __fish_use_subcommand -a stats -d 'produce VCF/BCF stats'
...
complete -c bcftools -n "__fish_seen_subcommand_from annotate" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from annotate" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from annotate" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from annotate" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from annotate" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from concat" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from concat" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from concat" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from concat" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from concat" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from isec" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from isec" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from isec" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from isec" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from isec" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from merge" -s 0 -d '--missing-to-ref               assume genotypes at missing sites are 0/0'
...
complete -c bcftools -n "__fish_seen_subcommand_from merge" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from merge" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from merge" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from merge" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from merge" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from norm" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from norm" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from norm" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from norm" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from norm" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from plugin" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from plugin" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from plugin" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from plugin" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from plugin" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from sort" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from sort" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from sort" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from sort" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from sort" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from view" -s h -l header-only -d 'print the header only'
...
complete -c bcftools -n "__fish_seen_subcommand_from view" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from view" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from view" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from view" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from view" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from view" -s c -l min-ac -d 'minimum count for non-reference (nref), 1st alternate (alt1), least frequent (minor), most frequent (major) or sum of all but most frequent (nonmajor) alleles [nref]' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s C -l max-ac -d 'maximum count for non-reference (nref), 1st alternate (alt1), least frequent (minor), most frequent (major) or sum of all but most frequent (nonmajor) alleles [nref]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from view" -s i -l include -d 'select sites for which the expression is true (see man page for details)' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s e -l exclude -d 'exclude sites for which the expression is true (see man page for details)' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s k -l known -d 'select known sites only (ID is not \'.\')'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s n -l novel -d 'select novel sites only (ID is \'.\')'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s m -l min-alleles -d 'minimum number of alleles listed in REF and ALT (e.g. -m2 -M2 for biallelic sites)' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s M -l max-alleles -d 'maximum number of alleles listed in REF and ALT (e.g. -m2 -M2 for biallelic sites)' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s p -l phased -d 'select sites where all samples are phased'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s P -l exclude-phased -d 'exclude sites where all samples are phased'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s q -l min-af -d 'minimum frequency for non-reference (nref), 1st alternate (alt1), least frequent (minor), most frequent (major) or sum of all but most frequent (nonmajor) alleles [nref]' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s Q -l max-af -d 'maximum frequency for non-reference (nref), 1st alternate (alt1), least frequent (minor), most frequent (major) or sum of all but most frequent (nonmajor) alleles [nref]' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s u -l uncalled -d 'select sites without a called genotype'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s U -l exclude-uncalled -d 'exclude sites without a called genotype'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s v -l types -d 'select comma-separated list of variant types: snps,indels,mnps,ref,bnd,other [null]' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s V -l exclude-types -d 'exclude comma-separated list of variant types: snps,indels,mnps,ref,bnd,other [null]' -x
complete -c bcftools -n "__fish_seen_subcommand_from view" -s x -l private -d 'select sites where the non-reference alleles are exclusive (private) to the subset samples'
complete -c bcftools -n "__fish_seen_subcommand_from view" -s X -l exclude-private -d 'exclude sites where the non-reference alleles are exclusive (private) to the subset samples'
...
complete -c bcftools -n "__fish_seen_subcommand_from call" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from call" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from call" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from call" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from call" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'first allele from GT, regardless of phasing' -x -a 1
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'second allele from GT, regardless of phasing' -x -a 2
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'REF allele in het genotypes' -x -a R
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'ALT allele' -x -a A
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'longer allele and REF if equal length' -x -a LR
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'longer allele and ALT if equal length' -x -a LA
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'shorter allele and REF if equal length' -x -a SR
complete -c bcftools -n "__fish_seen_subcommand_from consensus" -s H -l haplotype -d 'shorter allele and ALT if equal length' -x -a SA
...
complete -c bcftools -n "__fish_seen_subcommand_from cnv" -s o -l output-dir -d 'output directory' -r
complete -c bcftools -n "__fish_seen_subcommand_from cnv" -s p -l plot-threshold -d 'plot aberrant chromosomes with quality at least \'float\'' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s p -l phase -d 'take GTs as is, create haplotypes regardless of phase (0/1 -> 0|1)' -x -a a
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s p -l phase -d 'merge *all* GTs into a single haplotype (0/1 -> 1, 1/2 -> 1)' -x -a m
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s p -l phase -d 'require phased GTs, throw an error on unphased het GTs' -x -a r
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s p -l phase -d 'create non-reference haplotypes if possible (0/1 -> 1|1, 1/2 -> 1|2)' -x -a R
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s p -l phase -d 'skip unphased hets' -x -a s
...
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from csq" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from filter" -s m -l mode -d '"+": do not replace but add to existing FILTER; "x": reset filters at sites which pass'
...
complete -c bcftools -n "__fish_seen_subcommand_from filter" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from filter" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from filter" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from filter" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from filter" -s O -l output-type -d 'output file type [v]' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from gtcheck" -s s -l samples -d 'List of query or -g samples (by default all samples are compared)'
complete -c bcftools -n "__fish_seen_subcommand_from gtcheck" -s S -l samples-file -d 'File with the query or -g samples to compare'
...
complete -c bcftools -n "__fish_seen_subcommand_from mpileup" -s O -l output-type -d 'compressed BCF' -x -a b
complete -c bcftools -n "__fish_seen_subcommand_from mpileup" -s O -l output-type -d 'uncompressed BCF' -x -a u
complete -c bcftools -n "__fish_seen_subcommand_from mpileup" -s O -l output-type -d 'compressed VCF' -x -a z
complete -c bcftools -n "__fish_seen_subcommand_from mpileup" -s O -l output-type -d 'uncompressed VCF' -x -a v
complete -c bcftools -n "__fish_seen_subcommand_from mpileup" -s O -l output-type -d 'output file type [v]' -x
...
# polysomy
complete -c bcftools -n "__fish_seen_subcommand_from polysomy" -s o -l output-dir -d '-r, --regions <region>         restrict to comma-separated list of regions' -x
...
complete -c bcftools -n "__fish_seen_subcommand_from polysomy" -s v -l verbose -d 'Algorithm options:'
...
complete -c bcftools -n "__fish_seen_subcommand_from roh" -s b -d '--buffer-size <int>      buffer size and the number of overlapping sites, 0 for unlimited [0]'
