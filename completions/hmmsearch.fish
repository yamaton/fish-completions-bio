...
complete -c hmmsearch -s "o" -d "direct output to file <f>, not stdout" -r
complete -c hmmsearch -s "A" -d "save multiple alignment of all hits to file <f>" -r
complete -c hmmsearch -l "tblout" -d "save parseable table of per-sequence hits to file <f>" -r
complete -c hmmsearch -l "domtblout" -d "save parseable table of per-domain hits to file <f>" -r
complete -c hmmsearch -l "pfamtblout" -d "save table of hits and domains to file, in Pfam format <f>" -r
...
complete -c hmmsearch -l "cut_ga" -d "use profile's GA gathering cutoffs to set all thresholding"
complete -c hmmsearch -l "cut_nc" -d "use profile's NC noise cutoffs to set all thresholding"
complete -c hmmsearch -l "cut_tc" -d "use profile's TC trusted cutoffs to set all thresholding"
complete -c hmmsearch -l "max" -d "Turn all heuristic filters off (less speed, more power)"
...
complete -c hmmsearch -l "nobias" -d "turn off composition bias filter"
...
complete -c hmmsearch -l "tformat" -d "assert target <seqfile> is in format <s>: no autodetection" -r
