...
complete -c hmmalign -s "o" -d "output alignment to file <f>, not stdout" -r
complete -c hmmalign -l "mapali" -d "include alignment in file <f> (same ali that HMM came from)" -r
