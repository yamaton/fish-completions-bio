...
complete -k -c seqkit -n __fish_use_subcommand -x -a seq -d 'transform sequences (extract ID, filter by length, remove gaps...)'
...
complete -c seqkit -n "__fish_seen_subcommand_from bam" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from bam" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from concat" -s f -l full -d 'keep all sequences, like full/outter join'
...
complete -c seqkit -n "__fish_seen_subcommand_from fa2fq" -s f -l fasta-file -d 'FASTA file)' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from fa2fq" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from fa2fq" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from faidx" -s l -l region-file -d 'file containing a list of regions' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from fish" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from fish" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from fx2tab" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from fx2tab" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from genautocomplete" -l file -d 'autocompletion file (default "/home/vierbein/.bash_completion.d/seqkit.sh")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from grep" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from grep" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from head-genome" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from head-genome" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from locate" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from locate" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from mutate" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from mutate" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from pair" -s O -l out-dir -d 'output directory' -x
complete -c seqkit -n "__fish_seen_subcommand_from pair" -s 1 -l read1 -d '(gzipped) read1 file' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from replace" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from replace" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from rmdup" -s D -l dup-num-file -d 'file to save number and list of duplicated seqs' -x
complete -c seqkit -n "__fish_seen_subcommand_from rmdup" -s d -l dup-seqs-file -d 'file to save duplicated seqs' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from sample" -s n -l number -d 'sample by number (result may not exactly match), DO NOT use on large FASTQ files.' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from scat" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from scat" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from seq" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from seq" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from sort" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from sort" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from split" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from split" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from split2" -s e -l extension -d 'set output file extension, e.g., ".gz", ".xz", or ".zst"' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from subseq" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from subseq" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from sum" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from sum" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from translate" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from watch" -l infile-list -d 'file of input files list (one file per line), if given, they are appended to files from cli arguments' -x
...
complete -c seqkit -n "__fish_seen_subcommand_from watch" -s o -l out-file -d 'out file ("-" for stdout, suffix .gz for gzipped out) (default "-")' -x
