...
complete -k -c seqkit -n __fish_use_subcommand -x -a sliding -d 'sliding sequences, circular genome supported'
complete -k -c seqkit -n __fish_use_subcommand -x -a shuffle -d 'shuffle sequences'
complete -k -c seqkit -n __fish_use_subcommand -x -a seq -d 'transform sequences (revserse, complement, extract ID...)'
...
complete -k -c seqkit -n __fish_use_subcommand -x -a help -d 'Help about any command'
...
complete -k -c seqkit -n __fish_use_subcommand -x -a fx2tab -d 'convert FASTA/Q to tabular format (with length/GC content/GC skew)'
...
complete -k -c seqkit -n __fish_use_subcommand -x -a concat -d 'concatenate sequences with same ID from multiple files'
...
complete -k -c seqkit -n __fish_use_subcommand -x -a amplicon -d 'retrieve amplicon (or specific region around it) via primer(s)'
