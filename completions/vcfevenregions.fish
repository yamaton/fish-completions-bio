...
complete -c vcfevenregions -s l -l overlap -d 'The number of sites to overlap between regions.' -x
complete -c vcfevenregions -s s -l separator -d 'Specify string to use to separate region output.' -x
