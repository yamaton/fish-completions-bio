...
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "min-freq-for-hom" -d "Minimum frequency to call homozygote [0.75]" -x
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "normal-purity"  -d "of normal sample [1.00]" -x
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "normal-purity"  -d "of normal sample   --tumor-purity - Estimated purity (tumor content) of tumor sample [1.00]" -x
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "normal-purity"  -d "of normal sample 1.00   --tumor-purity - Estimated purity (tumor content) of tumor sample [1.00]" -x
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "tumor-purity"  -d "of tumor sample [1.00]" -x
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "tumor-purity"  -d "of tumor sample   --p-value - P-value threshold to call a heterozygote [0.99]" -x
complete -c varscan -n "__fish_seen_subcommand_from somatic" -l "tumor-purity"  -d "of tumor sample 1.00   --p-value - P-value threshold to call a heterozygote [0.99]" -x
