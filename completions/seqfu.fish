...
complete -c seqfu -n "__fish_seen_subcommand_from bases" -s "b" -l "basename" -d "Print the basename of the file"
complete -c seqfu -n "__fish_seen_subcommand_from bases" -s "n" -l "nice" -d "Print terminal table"
complete -c seqfu -n "__fish_seen_subcommand_from bases" -s "d" -l "digits" -d "Number of digits to print [default: 2]" -x
complete -c seqfu -n "__fish_seen_subcommand_from bases" -s "H" -l "header" -d "Print header"
complete -c seqfu -n "__fish_seen_subcommand_from bases" -s "v" -l "verbose" -d "Verbose output"
...
complete -c seqfu -n "__fish_seen_subcommand_from check" -s "v" -l "verbose" -d "Verbose output"
...
complete -c seqfu -n "__fish_seen_subcommand_from cat" -l "jump-to" -d "Start from the record after the one named STR (overrides --skip-first)" -x
complete -c seqfu -n "__fish_seen_subcommand_from cat" -l "print-last" -d "Print the name of the last sequence to STDERR (Last:NAME)"
...
complete -c seqfu -n "__fish_seen_subcommand_from head" -l "print-last" -d "Print the name of the last sequence to STDERR (Last:NAME)"
complete -c seqfu -n "__fish_seen_subcommand_from head" -l "fatal" -d "Exit with error if less than NUM sequences are found"
...
complete -c seqfu -n "__fish_seen_subcommand_from tail" -l "sep" -d "Sequence name fields separator [default: _]" -x
