...
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -s "C" -d "Use the specified configuration file(s) overriding any defaults"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -s "D" -d "Set JVM properties"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -o "bg" -d "Execute nextflow in background"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -s "c" -o "config" -d "Add the specified file to configuration set"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -o "config-ignore-includes" -d "Disable the parsing of config includes"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -s "d" -o "dockerize" -d "Launch nextflow via Docker (experimental)"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -s "h" -d "Print this help"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -o "log" -d "Set nextflow log file path"
complete -c nextflow -n "not __fish_seen_subcommand_from clean clone config console drop help info kuberun list log pull run secrets self-update view" -s "q" -o "quiet" -d "Do not print information messages"
...
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "disable-jobs-cancellation" -d "Prevent the cancellation of child jobs on execution termination"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "dsl1" -d "Execute the workflow using DSL1 syntax Default: false"
...
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "e." -d "Add the specified variable to execution environment Syntax: -e.key=value Default: {}" -x
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "entry" -d "Entry workflow name to be executed"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "head-cpus" -d "Specify number of CPUs requested for the Nextflow driver pod Default: 0"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "head-image" -d "Specify the container image for the Nextflow driver pod"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "head-memory" -d "Specify amount of memory requested for the Nextflow driver pod"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "head-prescript" -d "Specify script to be run before nextflow run starts"
...
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "pod-image" -d "Alias for -head-image (deprecated)"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "preview" -d "Run the workflow script skipping the execution of all processes Default: false"
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "process." -d "Set process options Syntax: -process.key=value Default: {}" -x
...
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "remoteProfile" -d "Choose a configuration profile in the remoteConfig"
...
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o "without-conda" -d "Disable the use of Conda environments"
...
complete -c nextflow -n "__fish_seen_subcommand_from run" -o "disable-jobs-cancellation" -d "Prevent the cancellation of child jobs on execution termination"
complete -c nextflow -n "__fish_seen_subcommand_from run" -o "dsl1" -d "Execute the workflow using DSL1 syntax Default: false"
...
complete -c nextflow -n "__fish_seen_subcommand_from run" -o "e." -d "Add the specified variable to execution environment Syntax: -e.key=value Default: {}" -x
...
complete -c nextflow -n "__fish_seen_subcommand_from run" -o "preview" -d "Run the workflow script skipping the execution of all processes Default: false"
complete -c nextflow -n "__fish_seen_subcommand_from run" -o "process." -d "Set process options Syntax: -process.key=value Default: {}" -x
...
complete -c nextflow -n "__fish_seen_subcommand_from run" -o "without-conda" -d "Disable the use of Conda environments"
