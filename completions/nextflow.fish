...
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o head-cpus -d 'Specify number of CPUs requested for the Nextflow pod Default: 0'
complete -c nextflow -n "__fish_seen_subcommand_from kuberun" -o head-memory -d 'Specify amount of memory requested for the Nextflow pod'
