...
complete -c mummerplot -s "p" -l "prefix" -d "Set the prefix of the output files (default 'out')"
...
complete -c mummerplot -s "s" -l "size" -d "Set the output size to small, medium or large"
complete -c mummerplot -s "S" -l "SNP" -d "Highlight SNP locations in each alignment"
complete -c mummerplot -s "t" -l "terminal" -d "Set the output terminal to x11, postscript or png --x11 --postscript --png (default 'x11')"
complete -c mummerplot -s "t" -l "title" -d "Specify the gnuplot plot title (default none)"
complete -c mummerplot -s "x" -l "xrange" -d "Set the xrange for the plot '[min:max]'"
complete -c mummerplot -s "y" -l "yrange" -d "Set the yrange for the plot '[min:max]'"
