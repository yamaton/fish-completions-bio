...
complete -c bowtie2 -l "very-fast" -d "(For --end-to-end) Same as -D 5 -R 1 -N 0 -L 22 -i S,0,2.50"
complete -c bowtie2 -l "fast" -d "(For --end-to-end) Same as -D 10 -R 2 -N 0 -L 22 -i S,0,2.50"
complete -c bowtie2 -l "sensitive" -d "(For --end-to-end) Same as -D 15 -R 2 -N 0 -L 22 -i S,1,1.15 (default)"
complete -c bowtie2 -l "very-sensitive" -d "(For --end-to-end) Same as -D 20 -R 3 -N 0 -L 20 -i S,1,0.50"
complete -c bowtie2 -l "very-fast-local" -d "(For --local) Same as -D 5 -R 1 -N 0 -L 25 -i S,1,2.00"
complete -c bowtie2 -l "fast-local" -d "(For --local) Same as -D 10 -R 2 -N 0 -L 22 -i S,1,1.75"
complete -c bowtie2 -l "sensitive-local" -d "(For --local) Same as -D 15 -R 2 -N 0 -L 20 -i S,1,0.75 (default)"
complete -c bowtie2 -l "very-sensitive-local" -d "(For --local) Same as -D 20 -R 3 -N 0 -L 20 -i S,1,0.50"
