...
complete -c bowtie2 -l trim-to -d 'trim reads exceeding <int> bases from either 3\' or 5\' end' -x
...
# under --end-to-end
complete -c bowtie2 -n "__fish_contains_opt end-to-end" -l very-fast -d 'Same as -D 5 -R 1 -N 0 -L 22 -i S,0,2.50'
complete -c bowtie2 -n "__fish_contains_opt end-to-end" -l fast -d 'Same as -D 10 -R 2 -N 0 -L 22 -i S,0,2.50'
complete -c bowtie2 -n "__fish_contains_opt end-to-end" -l sensitive -d 'Same as -D 15 -R 2 -N 0 -L 22 -i S,1,1.15 (default)'
complete -c bowtie2 -n "__fish_contains_opt end-to-end" -l very-sensitive -d 'Same as -D 20 -R 3 -N 0 -L 20 -i S,1,0.50'

# under --local
complete -c bowtie2 -n "__fish_contains_opt local" -l very-fast-local -d 'Same as -D 5 -R 1 -N 0 -L 25 -i S,1,2.00'
complete -c bowtie2 -n "__fish_contains_opt local" -l fast-local -d 'Same as -D 10 -R 2 -N 0 -L 22 -i S,1,1.75'
complete -c bowtie2 -n "__fish_contains_opt local" -l sensitive-local -d 'Same as -D 15 -R 2 -N 0 -L 20 -i S,1,0.75 (default)'
complete -c bowtie2 -n "__fish_contains_opt local" -l very-sensitive-local -d 'Same as -D 20 -R 3 -N 0 -L 20 -i S,1,0.50'
...
complete -c bowtie2 -l score-min -d 'min acceptable alignment score w/r/t read length' -x
...
complete -c bowtie2 -l fr -d '-1, -2 mates align fw/rev (--fr)'
complete -c bowtie2 -l rf -d '-1, -2 mates align rev/fw (--fr)'
complete -c bowtie2 -l ff -d '-1, -2 mates align fw/fw  (--fr)'
...
complete -c bowtie2 -l preserve-tags -d 'Preserve tags from the original BAM record by'
