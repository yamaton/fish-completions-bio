...
complete -k -c bedtools -n __fish_use_subcommand -x -a groupby -d "Group by common cols. & summarize oth. cols. (~ SQL \"groupBy\")"
complete -k -c bedtools -n __fish_use_subcommand -x -a makewindows -d "Make interval \"windows\" across a genome."
complete -k -c bedtools -n __fish_use_subcommand -x -a links -d "Create a HTML page of links to UCSC locations."
complete -k -c bedtools -n __fish_use_subcommand -x -a igv -d "Create an IGV snapshot batch script."
complete -k -c bedtools -n __fish_use_subcommand -x -a overlap -d "Computes the amount of overlap from two intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a fisher -d "Calculate Fisher statistic b/w two feature files."
complete -k -c bedtools -n __fish_use_subcommand -x -a reldist -d "Calculate the distribution of relative distances b/w two files."
complete -k -c bedtools -n __fish_use_subcommand -x -a jaccard -d "Calculate the Jaccard statistic b/w two sets of intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a tag -d "Tag BAM alignments based on overlaps with interval files."
complete -k -c bedtools -n __fish_use_subcommand -x -a multicov -d "Counts coverage from multiple BAMs at specific intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a nuc -d "Profile the nucleotide content of intervals in a FASTA file."
complete -k -c bedtools -n __fish_use_subcommand -x -a maskfasta -d "Use intervals to mask sequences from a FASTA file."
complete -k -c bedtools -n __fish_use_subcommand -x -a getfasta -d "Use intervals to extract sequences from a FASTA file."
complete -k -c bedtools -n __fish_use_subcommand -x -a bed12tobed6 -d "Breaks BED12 intervals into discrete BED6 intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a bedpetobam -d "Convert BEDPE intervals to BAM records."
complete -k -c bedtools -n __fish_use_subcommand -x -a bamtofastq -d "Convert BAM records to FASTQ records."
complete -k -c bedtools -n __fish_use_subcommand -x -a bedtobam -d "Convert intervals to BAM records."
complete -k -c bedtools -n __fish_use_subcommand -x -a bamtobed -d "Convert BAM alignments to BED (& other) formats."
complete -k -c bedtools -n __fish_use_subcommand -x -a pairtopair -d "Find pairs that overlap other pairs in various ways."
complete -k -c bedtools -n __fish_use_subcommand -x -a pairtobed -d "Find pairs that overlap intervals in various ways."
complete -k -c bedtools -n __fish_use_subcommand -x -a unionbedg -d "Combines coverage intervals from multiple BEDGRAPH files."
complete -k -c bedtools -n __fish_use_subcommand -x -a multiinter -d "Identifies common intervals among multiple interval files."
complete -k -c bedtools -n __fish_use_subcommand -x -a annotate -d "Annotate coverage of features from multiple files."
complete -k -c bedtools -n __fish_use_subcommand -x -a spacing -d "Report the gap lengths between intervals in a file."
complete -k -c bedtools -n __fish_use_subcommand -x -a sample -d "Sample random records from file using reservoir sampling."
complete -k -c bedtools -n __fish_use_subcommand -x -a shuffle -d "Randomly redistribute intervals in a genome."
complete -k -c bedtools -n __fish_use_subcommand -x -a random -d "Generate random intervals in a genome."
complete -k -c bedtools -n __fish_use_subcommand -x -a sort -d "Order the intervals in a file."
complete -k -c bedtools -n __fish_use_subcommand -x -a flank -d "Create new intervals from the flanks of existing intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a slop -d "Adjust the size of intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a subtract -d "Remove intervals based on overlaps b/w two files."
complete -k -c bedtools -n __fish_use_subcommand -x -a shift -d "Adjust the position of intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a complement -d "Extract intervals _not_ represented by an interval file."
complete -k -c bedtools -n __fish_use_subcommand -x -a cluster -d "Cluster (but don't merge) overlapping/nearby intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a merge -d "Combine overlapping/nearby intervals into a single interval."
complete -k -c bedtools -n __fish_use_subcommand -x -a genomecov -d "Compute the coverage over an entire genome."
complete -k -c bedtools -n __fish_use_subcommand -x -a map -d "Apply a function to a column for each overlapping interval."
complete -k -c bedtools -n __fish_use_subcommand -x -a coverage -d "Compute the coverage over defined intervals."
complete -k -c bedtools -n __fish_use_subcommand -x -a closest -d "Find the closest, potentially non-overlapping interval."
...
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -o "wo" -d "Write the original A and B entries plus the number of base pairs of overlap between the two features."
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -o "wao" -d "Write the original A and B entries plus the number of base pairs of overlap between the two features."
...
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -s "C" -d "For each entry in A, separately report the number of - overlaps with each B file on a distinct line."
...
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
...
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -o "names" -d "When using multiple databases, provide an alias for each that will appear instead of a fileId when also printing the DB record."
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -o "filenames" -d "When using multiple databases, show each complete filename instead of a fileId when also printing the DB record."
complete -c bedtools -n "__fish_seen_subcommand_from intersect" -o "sortout" -d "When using multiple databases, sort the output DB hits for each record."
...
complete -c bedtools -n "__fish_seen_subcommand_from closest" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
complete -c bedtools -n "__fish_seen_subcommand_from closest" -o "nonamecheck" -d "For sorted data, don't throw an error if the file has different naming conventions for the same chromosome."
complete -c bedtools -n "__fish_seen_subcommand_from closest" -o "names" -d "When using multiple databases, provide an alias for each that will appear instead of a fileId when also printing the DB record."
complete -c bedtools -n "__fish_seen_subcommand_from closest" -o "filenames" -d "When using multiple databases, show each complete filename instead of a fileId when also printing the DB record."
complete -c bedtools -n "__fish_seen_subcommand_from closest" -o "sortout" -d "When using multiple databases, sort the output DB hits for each record."
...
complete -c bedtools -n "__fish_seen_subcommand_from coverage" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
complete -c bedtools -n "__fish_seen_subcommand_from coverage" -o "nonamecheck" -d "For sorted data, don't throw an error if the file has different naming conventions for the same chromosome."
...
complete -c bedtools -n "__fish_seen_subcommand_from map" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
complete -c bedtools -n "__fish_seen_subcommand_from map" -o "nonamecheck" -d "For sorted data, don't throw an error if the file has different naming conventions for the same chromosome."
...
complete -c bedtools -n "__fish_seen_subcommand_from genomecov" -o "ignoreD" -d "Ignore local deletions (CIGAR \"D\" operations) in BAM entries when computing coverage."
...
complete -c bedtools -n "__fish_seen_subcommand_from genomecov" -o "fs" -d "Force to use provided fragment size instead of read length Works for BAM files only"
complete -c bedtools -n "__fish_seen_subcommand_from genomecov" -o "du" -d "Change strand af the mate read (so both reads from the same strand) useful for strand specific Works for BAM files only"
...
complete -c bedtools -n "__fish_seen_subcommand_from genomecov" -o "max" -d "Combine all positions with a depth >= max into a single bin in the histogram."
...
complete -c bedtools -n "__fish_seen_subcommand_from subtract" -o "wo" -d "Write the original A and B entries plus the number of base pairs of overlap between the two features."
...
complete -c bedtools -n "__fish_seen_subcommand_from subtract" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
complete -c bedtools -n "__fish_seen_subcommand_from subtract" -o "nonamecheck" -d "For sorted data, don't throw an error if the file has different naming conventions for the same chromosome."
...
complete -c bedtools -n "__fish_seen_subcommand_from shuffle" -s "f" -d "Maximum overlap (as a fraction of the -i feature) with an -excl feature that is tolerated before searching for a new, randomized locus."
complete -c bedtools -n "__fish_seen_subcommand_from shuffle" -o "chromFirst" -d "Instead of choosing a position randomly among the entire genome (the default), first choose a chrom randomly, and then choose a random start coordinate on that chrom."
...
complete -c bedtools -n "__fish_seen_subcommand_from multiinter" -o "names" -d "A list of names (one/file) to describe each file in -i."
complete -c bedtools -n "__fish_seen_subcommand_from multiinter" -s "g" -d "Use genome file to calculate empty regions."
complete -c bedtools -n "__fish_seen_subcommand_from multiinter" -o "empty" -d "Report empty regions (i.e., start/end intervals w/o values in all files)."
...
complete -c bedtools -n "__fish_seen_subcommand_from getfasta" -o "split" -d "Given BED12 fmt., extract and concatenate the sequences from the BED \"blocks\" (e.g., exons)"
...
complete -c bedtools -n "__fish_seen_subcommand_from jaccard" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
...
complete -c bedtools -n "__fish_seen_subcommand_from fisher" -s "g" -d "Provide a genome file to enforce consistent chromosome sort order across input files."
...
complete -c bedtools -n "__fish_seen_subcommand_from makewindows" -s "w" -d "Divide each input interval (either a chromosome or a BED interval) to fixed-sized windows (i.e. same number of nucleotide in each window)." -x
complete -c bedtools -n "__fish_seen_subcommand_from makewindows" -s "s" -d "Step size: i.e., how many base pairs to step before creating a new window." -x
