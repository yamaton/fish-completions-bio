...
complete -c nucmer -l "delta" -d "Output delta file to PATH (instead of PREFIX.delta)" -r
complete -c nucmer -l "sam-short" -d "Output SAM file to PATH, short format" -r
complete -c nucmer -l "sam-long" -d "Output SAM file to PATH, long format" -r
complete -c nucmer -l "save" -d "Save suffix array to files starting with PREFIX" -r
complete -c nucmer -l "load" -d "Load suffix array from file starting with PREFIX" -r
...
complete -c nucmer -s "U" -l "usage" -s "h" -l "help" -d "This message" -x
