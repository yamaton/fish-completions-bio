...
complete -c samtools -n "__fish_seen_subcommand_from faidx" -s i -l reverse-complement -d ' Reverse complement sequences.' -r
complete -c samtools -n "__fish_seen_subcommand_from fqidx" -l fai-idx -d 'name of the index file (default file.fq.fai).' -r
complete -c samtools -n "__fish_seen_subcommand_from fqidx" -l gzi-idx -d 'name of compressed file index (default file.fq.gz.gzi).' -r
...
complete -c samtools -n "__fish_seen_subcommand_from index" -s m -d 'Set minimum interval size for CSI indices to 2^INT [14]' -r
complete -c samtools -n "__fish_seen_subcommand_from index" -s @ -d 'Sets the number of threads [none]' -r
...
complete -c samtools -n "__fish_seen_subcommand_from calmd" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from calmd" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from calmd" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from calmd" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from calmd" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from calmd" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from fixmate" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
...
complete -c samtools -n "__fish_seen_subcommand_from reheader" -s c -l command -d 'Pass the header in SAM format to external program CMD.'

# targetcut
complete -c samtools -n "__fish_seen_subcommand_from targetcut" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from targetcut" -s f -l reference -d 'Reference sequence FASTA FILE [null]' -x
complete -c samtools -n "__fish_seen_subcommand_from targetcut" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -s r -d '@RG line text' -r
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -s R -d 'ID of @RG line in existing header to use' -r
...
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l input-fmt -d 'Specify input format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l write-index -d 'Automatically index the output files [off]'
complete -c samtools -n "__fish_seen_subcommand_from addreplacerg" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from markdup" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from markdup" -s O -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from markdup" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
...
# ampliconclip
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -s b -d 'bedfile of amplicons to be removed.' -r
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -s o -d 'output file name (default stdout).' -r
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -s f -d 'write stats to file name (default stderr)' -r
...
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -l fail-len -d 'mark as QCFAIL reads INT size or shorter.' -x
...
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -l input-fmt-option -d 'Specify a single input file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -s O -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -l output-fmt-option -d 'Specify a single output file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from ampliconclip" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from collate" -l input-fmt-option -d 'Specify a single input file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from collate" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from collate" -l output-fmt-option -d 'Specify a single output file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from collate" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from collate" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from collate" -l verbosity -d 'Set level of verbosity' -x

# cat
complete -c samtools -n "__fish_seen_subcommand_from cat" -s b -d 'list of input BAM/CRAM file names, one per line' -r
complete -c samtools -n "__fish_seen_subcommand_from cat" -s h -d 'copy the header from FILE [default is 1st input file]' -r
complete -c samtools -n "__fish_seen_subcommand_from cat" -s o -d 'output BAM/CRAM' -r
complete -c samtools -n "__fish_seen_subcommand_from cat" -l no-PG -d 'do not add a PG line'
complete -c samtools -n "__fish_seen_subcommand_from cat" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from cat" -l output-fmt-option -d 'Specify a single output file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from cat" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from cat" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from merge" -l input-fmt-option -d 'Specify a single input file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from merge" -s O -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from merge" -l output-fmt-option -d 'Specify a single output file format option in the form' -x
complete -c samtools -n "__fish_seen_subcommand_from merge" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from merge" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from merge" -l write-index -d 'Automatically index the output files [off]'
complete -c samtools -n "__fish_seen_subcommand_from merge" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from mpileup" -l output-empty -d 'set the no value character for tag lists [*]' -x
complete -c samtools -n "__fish_seen_subcommand_from mpileup" -l reverse-del -d 'use \'#\' character for deletions on the reverse strand'
...
complete -c samtools -n "__fish_seen_subcommand_from mpileup" -l input-fmt-option -d 'Specify a single input file format option in the formof OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from sort" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from sort" -s O -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from sort" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from sort" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from sort" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from sort" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from split" -s h -d 'override the header with FILE2 (-u file only)' -r
...
complete -c samtools -n "__fish_seen_subcommand_from split" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from split" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from split" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from fastq" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from fasta" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from bedcov" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from coverage" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from depth" -o aa -d 'output absolutely all positions, including unused ref.'
...
complete -c samtools -n "__fish_seen_subcommand_from depth" -s G -d 'add the specified flags to the set used to filter out reads' -x
complete -c samtools -n "__fish_seen_subcommand_from depth" -s J -d 'include reads with deletions in depth computation'
complete -c samtools -n "__fish_seen_subcommand_from depth" -s s -d 'for the overlapping section of a read pair, count only the bases'
complete -c samtools -n "__fish_seen_subcommand_from depth" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from depth" -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from depth" -l verbosity -d 'Set level of verbosity' -x
...
complete -c samtools -n "__fish_seen_subcommand_from flagstat" -l output-fmt -d 'Specify output format' -x -a "json tsv"

# idxstats
complete -c samtools -n "__fish_seen_subcommand_from idxstats" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
# phase
complete -c samtools -n "__fish_seen_subcommand_from phase" -s k -d 'block length [13]' -x
...
complete -c samtools -n "__fish_seen_subcommand_from phase" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from phase" -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from phase" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from stats" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from ampliconstats" -s I -l input-fmt -d 'Specify input format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from ampliconstats" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from tview" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
...
complete -c samtools -n "__fish_seen_subcommand_from view" -s m -d 'only include reads with number of CIGAR operations consuming' -x
...
complete -c samtools -n "__fish_seen_subcommand_from view" -s s -d 'subsample reads (given INT.FRAC option value, 0.FRAC is the fraction of templates/read pairs to keep; INT part sets seed)' -x
...
complete -c samtools -n "__fish_seen_subcommand_from view" -l input-fmt-option -d 'Specify a single input file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from view" -s O -l output-fmt -d 'Specify output format (SAM, BAM, CRAM)' -x
complete -c samtools -n "__fish_seen_subcommand_from view" -l output-fmt-option -d 'Specify a single output file format option in the form of OPTION or OPTION=VALUE' -x
complete -c samtools -n "__fish_seen_subcommand_from view" -s T -l reference -d 'Reference sequence FASTA FILE [null]' -r
complete -c samtools -n "__fish_seen_subcommand_from view" -s @ -l threads -d 'Number of additional threads to use [0]' -x
complete -c samtools -n "__fish_seen_subcommand_from view" -l write-index -d 'Automatically index the output files [off]'
complete -c samtools -n "__fish_seen_subcommand_from view" -l verbosity -d 'Set level of verbosity' -x
