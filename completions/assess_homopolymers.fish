...
complete -c assess_homopolymers -n "__fish_seen_subcommand_from count" -s "t" -l "threads" -d "Number of threads for parallel execution." -x
...
complete -c assess_homopolymers -n "__fish_seen_subcommand_from count" -s "b" -l "bed" -d "Bed file to limit search." -r
