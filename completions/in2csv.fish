...
complete -c in2csv -s u -l quoting -d 'Quoting style used in the input CSV file.' -x
...
complete -c in2csv -s z -l maxfieldsize -d 'Maximum length of a single field in the input CSV file.' -x
...
complete -c in2csv -s f -l format -d 'The format of the input file.' -x
complete -c in2csv -s s -l schema -d 'Specify a CSV-formatted schema file for converting fixed-width files.' -x
