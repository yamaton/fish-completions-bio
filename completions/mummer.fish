...
complete -c mummer -s "k" -d "sampled suffix positions (one by default)"
...
complete -c mummer -o "suflink" -d "use suffix links (1=yes or 0=no) in the index and during search [auto]"
complete -c mummer -o "child" -d "use child table (1=yes or 0=no) in the index and during search [auto]"
...
complete -c mummer -o "kmer" -d "use kmer table containing sa-intervals (speeds up searching first k characters) in the index and during search [int value, auto]"
complete -c mummer -o "save" -d "save index to file to use again later (string)" -r
complete -c mummer -o "load" -d "load index from file" -r
