...
complete -c hmmscan -l "cut_ga" -d "use profile's GA gathering cutoffs to set all thresholding"
complete -c hmmscan -l "cut_nc" -d "use profile's NC noise cutoffs to set all thresholding"
complete -c hmmscan -l "cut_tc" -d "use profile's TC trusted cutoffs to set all thresholding"
complete -c hmmscan -l "max" -d "Turn all heuristic filters off (less speed, more power)"
complete -c hmmscan -l "F1" -d "MSV threshold: promote hits w/ P <= F1 [0.02]" -x
complete -c hmmscan -l "F2" -d "Vit threshold: promote hits w/ P <= F2 [1e-3]" -x
complete -c hmmscan -l "F3" -d "Fwd threshold: promote hits w/ P <= F3 [1e-5]" -x
complete -c hmmscan -l "nobias" -d "turn off composition bias filter"
