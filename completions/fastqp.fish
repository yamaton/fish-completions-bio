...
complete -c fastqp -s a -l name -d 'sample name identifier for text and graphics output (default: input file name)' -x
...
complete -c fastqp -s e -l text -d 'file name for text output (default: -)' -x
complete -c fastqp -s t -l type -d 'file type (default: auto)' -x
