...
complete -c platanus_b -n "__fish_seen_subcommand_from iterate" -o "ip" -d "lib_id inward_pair_file (reads in 1 file, fasta or fastq)" -r
complete -c platanus_b -n "__fish_seen_subcommand_from iterate" -o "IP" -d "lib_id inward_pair_files (reads in 2 files, fasta or fastq)" -r
complete -c platanus_b -n "__fish_seen_subcommand_from iterate" -o "op" -d "lib_id outward_pair_file (reads in 1 file, fasta or fastq)" -r
complete -c platanus_b -n "__fish_seen_subcommand_from iterate" -o "OP" -d "lib_id outward_pair_files (reads in 2 files, fasta or fastq)" -r
...
complete -c platanus_b -n "__fish_seen_subcommand_from iterate" -o "sub_bin" -d "directory for binary files which platanus_b use internally (e.g. minimap2) (default ~/repos/Platanus_B/sub_bin)" -r
