...
complete -c csvjoin -s u -l quoting -d 'Quoting style used in the input CSV file.' -x
...
complete -c csvjoin -s z -l maxfieldsize -d 'Maximum length of a single field in the input CSV file.' -x
...
complete -c csvjoin -s y -l snifflimit -d 'Limit CSV dialect sniffing to the specified number of bytes.' -x
