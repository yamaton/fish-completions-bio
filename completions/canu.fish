...
complete -c canu -o "gridOptionscormhap" -o "gridOptionsCORmhap" -d "Grid engine options applied to mhap overlaps for correction jobs"
complete -c canu -o "gridOptionscormmap" -o "gridOptionsCORmmap" -d "Grid engine options applied to mmap overlaps for correction jobs"
complete -c canu -o "gridOptionscorovl" -o "gridOptionsCORovl" -d "Grid engine options applied to overlaps for correction jobs"
...
complete -c canu -o "gridOptionsobtmhap" -o "gridOptionsOBTmhap" -d "Grid engine options applied to mhap overlaps for trimming jobs"
complete -c canu -o "gridOptionsobtmmap" -o "gridOptionsOBTmmap" -d "Grid engine options applied to mmap overlaps for trimming jobs"
complete -c canu -o "gridOptionsobtovl" -o "gridOptionsOBTovl" -d "Grid engine options applied to overlaps for trimming jobs"
...
complete -c canu -o "gridOptionsutgmhap" -o "gridOptionsUTGmhap" -d "Grid engine options applied to mhap overlaps for unitig construction jobs"
complete -c canu -o "gridOptionsutgmmap" -o "gridOptionsUTGmmap" -d "Grid engine options applied to mmap overlaps for unitig construction jobs"
complete -c canu -o "gridOptionsutgovl" -o "gridOptionsUTGovl" -d "Grid engine options applied to overlaps for unitig construction jobs"
...
complete -c canu -o "ovlmemory" -o "ovlMemory" -d "Alias of -corOvlMemory and -obtOvlMemory and -utgOvlMemory"
complete -c canu -o "mhapmemory" -o "mhapMemory" -d "Aliases for -cormhapMemory and -obtmhapMemory and -utgmhapMemory"
complete -c canu -o "mmapmemory" -o "mmapMemory" -d "Aliases for -cormmapMemory and -obtmmapMemory and -utgmmapMemory"
complete -c canu -o "ovlthreads" -o "ovlThreads" -d "Aliases for -corovlThreads and -obtovlThreads and -utgovlThreads"
complete -c canu -o "mhapthreads" -o "mhapThreads" -d "Aliases for -cormhapThreads and -obtmhapThreads and -utgmhapThreads"
complete -c canu -o "mmapthreads" -o "mmapThreads" -d "Aliases for -cormmapThreads and -obtmmapThreads and -utgmmapThreads"
complete -c canu -o "ovlconcurrency" -o "ovlConcurrency" -d "Aliases for -corovlConcurrency and -obtovlConcurrency and -utgovlConcurrency"
complete -c canu -o "mhapconcurrency" -o "mhapConcurrency" -d "Aliases for -cormhapConcurrency and -obtmhapConcurrency and -utgmhapConcurrency"
complete -c canu -o "mmapconcurrency" -o "mmapConcurrency" -d "Aliases for -cormmapConcurrency and -obtmmapConcurrency and -utgmmapConcurrency"
complete -c canu -o "overlapper" -d "Aliases for -corOverlapper and -obtOverlapper and -utgOverlapper"
complete -c canu -o "realign" -d "Aliases for -corReAlign and -obtReAlign and -utgReAlign"
complete -c canu -o "ovlerrorrate" -o "ovlErrorRate" -d "Aliases for -corOvlErrorRate and -obtOvlErrorRate and -utgOvlErrorRate"
complete -c canu -o "ovlhashblocklength" -o "ovlHashBlockLength" -d "AAliases for -corOvlHashBlockLength and -obtOvlHashBlockLength and -utgOvlHashBlockLength"
complete -c canu -o "ovlrefblocklength" -o "ovlRefBlockLength" -d "Aliases for -corOvlRefBlockLength and -obtOvlRefBlockLength and -utgOvlRefBlockLength"
complete -c canu -o "ovlhashbits" -o "ovlHashBits" -d "Aliases for -corOvlHashBits and -obtOvlHashBits and -utgOvlHashBits"
complete -c canu -o "ovlhashload" -o "ovlHashLoad" -d "Aliases for -corOvlHashLoad and -obtOvlHashLoad and -utgOvlHashLoad"
complete -c canu -o "ovlmersize" -o "ovlMerSize" -d "Aliases for -corOvlOvlMerSize and -obtOvlOvlMerSize and -utgOvlOvlMerSize"
complete -c canu -o "ovlmerthreshold" -o "ovlMerThreshold" -d "Aliases for -corOvlMerThreshold and -obtOvlMerThreshold and -utgOvlMerThreshold"
complete -c canu -o "ovlmerdistinct" -o "ovlMerDistinct" -d "Aliases for -corOvlMerDistinct and -obtOvlMerDistinct and -utgOvlMerDistinct"
complete -c canu -o "ovlfrequentmers" -o "ovlFrequentMers" -d "Aliases for -corOvlFrequentMers and -obtOvlFrequentMers and -utgOvlFrequentMers"
complete -c canu -o "mhapblocksize" -o "mhapBlockSize" -d "Aliases for -corMhapBlockSize and -obtMhapBlockSize and -utgMhapBlockSize"
complete -c canu -o "mhapmersize" -o "mhapMerSize" -d "Aliases for -corMhapMerSize and -obtMhapMerSize and -utgMhapMerSize"
complete -c canu -o "mhapsensitivity" -o "mhapSensitivity" -d "Aliases for -corMhapSensitivity and -obtMhapSensitivity and -utgMhapSensitivity"
complete -c canu -o "mhapfilterunique" -o "mhapFilterUnique" -d "Aliases for -corMhapFilterUnique and -obtMhapFilterUnique and -utgMhapFilterUnique"
complete -c canu -o "mhapfilterthreshold" -o "mhapFilterThreshold" -d "Aliases for -corMhapFilterThreshold and -obtMhapFilterThreshold and -utgMhapFilterThreshold"
complete -c canu -o "mhapnotf" -o "mhapNoTf" -d "Aliases for -corMhapNoTf and -obtMhapNoTf and -utgMhapNoTf"
complete -c canu -o "mhappipe" -o "mhapPipe" -d "Aliases for -corMhapPipe and -obtMhapPipe and -utgMhapPipe"
complete -c canu -o "mmapblocksize" -o "mmapBlockSize" -d "Aliases for -corMMapBlockSize and -obtMMapBlockSize and -utgMMapBlockSize"
complete -c canu -o "mmapmersize" -o "mmapMerSize" -d "Aliases for -corMMapMerSize and -obtMMapMerSize and -utgMMapMerSize"
