...
complete -c delly -n "__fish_seen_subcommand_from call" -s "v" -l "vcffile" -d "input VCF/BCF file for genotyping" -r
...
complete -c delly -n "__fish_seen_subcommand_from filter" -s "s" -l "samples" -d "Two-column sample file listing sample name and tumor or control" -r
...
complete -c delly -n "__fish_seen_subcommand_from cnv" -s "l" -l "svfile" -d "delly SV file for breakpoint refinement" -r
complete -c delly -n "__fish_seen_subcommand_from cnv" -s "v" -l "vcffile" -d "input VCF/BCF file for re-genotyping" -r
...
complete -c delly -n "__fish_seen_subcommand_from cnv" -s "b" -l "bed-intervals" -d "input BED file" -r
...
complete -c delly -n "__fish_seen_subcommand_from classify" -s "o" -l "outfile" -d "Filtered CNV BCF output file" -r
...
complete -c delly -n "__fish_seen_subcommand_from classify" -s "s" -l "samples" -d "Two-column sample file listing sample name and tumor or control" -r
